...
function library:CreateWindow(options, ...)
	...
	function windowFunctions:CreateDesigner(options, ...)
		...
		local backgroundthemesection = designer:CreateSection({
        ...
        backgroundthemesection:AddDropdown({
            Name = "Background Themes",
            List = {
                [1] = "Heart Pattern", -- 6073763729
                [2] = "Abstract Pattern", -- 6073743880
                [3] = "Hexagon Pattern", -- 6073628849
                [4] = "Circle Pattern", -- 6071579805
                [5] = "Flower Pattern", -- 6071575946
                [6] = "Floral Pattern", -- 5553946671
            },
		...
		local daaata = {{"AddTextbox", "__Designer.Textbox.ImageAssetID", backgroundsection, {
			Name = "Image Asset ID",
			Placeholder = "rbxassetid://9284931857",
			Flag = "__Designer.Background.ImageAssetID",
			Value = "rbxassetid://9284931857",
			...
			Callback = function(newValue)
                designerelements["__Designer.Textbox.ImageAssetID"]:Set("rbxassetid://" .. tostring(BackgroundThemes[newValue]))
            end
